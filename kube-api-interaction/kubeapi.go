...
func PodExecutor(pod *apiv1.Pod) {
	...
	fmt.Printf("After 30s Trying to execute command")
	ExecCommandInContainerWithFullOutput("default", "demo-pod", "tcpdump", "echo \"hi\" > /var/tmp/o.pcap")
